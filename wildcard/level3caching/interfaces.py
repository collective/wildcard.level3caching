...
class ILevel3CachingSettings(Interface):
    ...
    skipped_paths = schema.List(
        ...
        description=u"Specify Paths that are excluded from automatic "
                    u"invalidation. These should be absolute paths with the "
                    u"root being the Plone site.",
        default=[],
        missing_value=[],
